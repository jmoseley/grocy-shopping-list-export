...
export class CalendarApi {
   ...
   */
  public async calendarIcalGet(
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: string }> {
    const localVarPath = this.basePath + "/calendar/ical";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
    );
    const produces = ["text/calendar", "application/json"];
   ...
   */
  public async calendarIcalSharingLinkGet(
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: InlineResponse2002 }> {
    const localVarPath = this.basePath + "/calendar/ical/sharing-link";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
